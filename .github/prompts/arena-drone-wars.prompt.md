...
| Object Name | Purpose | Documentation |
|------------|---------|---------------|
| `[BuildingBlock] Camera Rig` | OVRCameraRig for head/hand tracking | [Camera Rig](https://developers.meta.com/horizon/documentation/unity/unity-ovrcamerarig) |
| `[BuildingBlock] Passthrough` | MR passthrough layer | [Passthrough](https://developers.meta.com/horizon/documentation/unity/unity-passthrough-gs) |
| `[BuildingBlock] Network Manager` | Unity NGO NetworkRunner | [Multiplayer Blocks](https://developers.meta.com/horizon/documentation/unity/bb-multiplayer-blocks) |
| `[BuildingBlock] MR Utility Kit` | MRUK for room mesh | [MR Utility Kit](https://developers.meta.com/horizon/documentation/unity/unity-mr-utility-kit-overview) |
| `[BuildingBlock] Colocation` | OVRColocationSession for alignment | [Colocation](https://developers.meta.com/horizon/documentation/unity/unity-colocation-overview) |
| `[BuildingBlock] Local Matchmaking` | Local network discovery | [Local Matchmaking](https://developers.meta.com/horizon/documentation/unity/bb-multiplayer-blocks) |
| `[BuildingBlock] OVRInteractionComprehensive` | Hand/controller input | [Interaction SDK](https://developers.meta.com/horizon/documentation/unity/unity-isdk-add-comprehensive-interaction-rig) |
| `[BuildingBlock] Occlusion` | Depth occlusion rendering | [Occlusion](https://developers.meta.com/horizon/documentation/unity/unity-depthapi-occlusions-get-started) |
