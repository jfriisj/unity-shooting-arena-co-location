...
1.  **Scene Scan:**
    ...
    * Capture relevant public fields and references.
    * Note any discrepancies.
    * Create a structured representation of the hierarchy and components.
    * Record data flow connections between major systems (e.g., which Manager references which BuildingBlock).
    * Highlight any missing or extra elements.
2.  **Logic Trace:**
